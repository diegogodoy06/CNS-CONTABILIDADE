...
@ApiTags('Admin - Comunicação')
@ApiBearerAuth()
@Controller('admin/comunicacao')
@UseGuards(JwtAuthGuard, RolesGuard)
@Roles(TipoUsuario.ADMIN_SISTEMA, TipoUsuario.ADMIN_ESCRITORIO, TipoUsuario.COLABORADOR)
export class ComunicacaoAdminController {
  constructor(private comunicacaoService: ComunicacaoService) {}

  @Post('mensagens')
  @ApiOperation({ summary: 'Enviar mensagem para cliente ou colaborador' })
